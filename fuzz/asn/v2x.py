...
class BSM:
    ...
    _MessageFrame_bsmFrame = SEQ(name='bsmFrame', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'BasicSafetyMessage')))
    _MessageFrame_mapFrame = SEQ(name='mapFrame', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'MapData')))
    _MessageFrame_rsmFrame = SEQ(name='rsmFrame', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'RoadSideSafetyMessage')))
    _MessageFrame_spatFrame = SEQ(name='spatFrame', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'SPAT')))
    _MessageFrame_rsiFrame = SEQ(name='rsiFrame', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'RoadSideInformation')))
    ...
    _BasicSafetyMessage_msgCnt = INT(name='msgCnt', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'MsgCount')))
    ...
    _BasicSafetyMessage_secMark = INT(name='secMark', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'DSecond')))
    _BasicSafetyMessage_timeConfidence = ENUM(name='timeConfidence', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'TimeConfidence')), opt=True)
    _BasicSafetyMessage_pos = SEQ(name='pos', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Position3D')))
    _BasicSafetyMessage_posAccuracy = SEQ(name='posAccuracy', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'PositionalAccuracy')), opt=True)
    _BasicSafetyMessage_posConfidence = SEQ(name='posConfidence', mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'PositionConfidenceSet')), opt=True)
    _BasicSafetyMessage_transmission = ENUM(name='transmission', mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'TransmissionState')))
    _BasicSafetyMessage_speed = INT(name='speed', mode=MODE_TYPE, tag=(8, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Speed')))
    _BasicSafetyMessage_heading = INT(name='heading', mode=MODE_TYPE, tag=(9, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Heading')))
    _BasicSafetyMessage_angle = INT(name='angle', mode=MODE_TYPE, tag=(10, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'SteeringWheelAngle')), opt=True)
    _BasicSafetyMessage_motionCfd = SEQ(name='motionCfd', mode=MODE_TYPE, tag=(11, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'MotionConfidenceSet')), opt=True)
    _BasicSafetyMessage_accelSet = SEQ(name='accelSet', mode=MODE_TYPE, tag=(12, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'AccelerationSet4Way')))
    _BasicSafetyMessage_brakes = SEQ(name='brakes', mode=MODE_TYPE, tag=(13, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'BrakeSystemStatus')))
    _BasicSafetyMessage_size = SEQ(name='size', mode=MODE_TYPE, tag=(14, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'VehicleSize')))
    _BasicSafetyMessage_vehicleClass = SEQ(name='vehicleClass', mode=MODE_TYPE, tag=(15, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'VehicleClassification')))
    _BasicSafetyMessage_safetyExt = SEQ(name='safetyExt', mode=MODE_TYPE, tag=(16, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'VehicleSafetyExtensions')), opt=True)
    _BasicSafetyMessage_emergencyExt = SEQ(name='emergencyExt', mode=MODE_TYPE, tag=(17, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'VehicleEmergencyExtensions')), opt=True)
    ...
    _MapData_msgCnt = INT(name='msgCnt', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'MsgCount')))
    _MapData_timeStamp = INT(name='timeStamp', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'MinuteOfTheYear')), opt=True)
    _MapData_nodes = SEQ_OF(name='nodes', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'NodeList')))
    ...
    _RoadSideInformation_msgCnt = INT(name='msgCnt', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'MsgCount')))
    _RoadSideInformation_moy = INT(name='moy', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'MinuteOfTheYear')), opt=True)
    ...
    _RoadSideInformation_refPos = SEQ(name='refPos', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Position3D')))
    _RoadSideInformation_rtes = SEQ_OF(name='rtes', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'RTEList')), opt=True)
    _RoadSideInformation_rtss = SEQ_OF(name='rtss', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'RTSList')), opt=True)
    ...
    _RoadSideSafetyMessage_msgCnt = INT(name='msgCnt', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'MsgCount')))
    ...
    _RoadSideSafetyMessage_refPos = SEQ(name='refPos', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Position3D')))
    _RoadSideSafetyMessage_participants = SEQ_OF(name='participants', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'ParticipantList')))
    ...
    _SPAT_msgCnt = INT(name='msgCnt', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'MsgCount')))
    _SPAT_moy = INT(name='moy', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'MinuteOfTheYear')), opt=True)
    _SPAT_timeStamp = INT(name='timeStamp', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'DSecond')), opt=True)
    _SPAT_name = STR_IA5(name='name', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'DescriptiveName')), opt=True)
    _SPAT_intersections = SEQ_OF(name='intersections', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'IntersectionStateList')))
    SPAT._cont = ASN1Dict([
        ('msgCnt', _SPAT_msgCnt),
        ('moy', _SPAT_moy),
    ...
    _AccelerationSet4Way_long = INT(name='long', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Acceleration')))
    _AccelerationSet4Way_lat = INT(name='lat', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Acceleration')))
    _AccelerationSet4Way_vert = INT(name='vert', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'VerticalAcceleration')))
    _AccelerationSet4Way_yaw = INT(name='yaw', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'YawRate')))
    ...
    _BrakeSystemStatus_brakePadel = ENUM(name='brakePadel', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'BrakePedalStatus')), opt=True)
    _BrakeSystemStatus_wheelBrakes = BIT_STR(name='wheelBrakes', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'BrakeAppliedStatus')), opt=True)
    _BrakeSystemStatus_traction = ENUM(name='traction', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'TractionControlStatus')), opt=True)
    _BrakeSystemStatus_abs = ENUM(name='abs', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'AntiLockBrakeStatus')), opt=True)
    _BrakeSystemStatus_scs = ENUM(name='scs', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'StabilityControlStatus')), opt=True)
    _BrakeSystemStatus_brakeBoost = ENUM(name='brakeBoost', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'BrakeBoostApplied')), opt=True)
    _BrakeSystemStatus_auxBrakes = ENUM(name='auxBrakes', mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'AuxiliaryBrakeStatus')), opt=True)
    ...
    _ConnectingLane_lane = INT(name='lane', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'LaneID')))
    _ConnectingLane_maneuver = BIT_STR(name='maneuver', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'AllowedManeuvers')), opt=True)
    ...
    _Connection_remoteintersection = SEQ(name='remoteintersection', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'NodeReferenceID')))
    _Connection_connectingLane = SEQ(name='connectingLane', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'ConnectingLane')), opt=True)
    _Connection_phaseId = INT(name='phaseId', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'PhaseID')), opt=True)
    ...
    _ConnectsToList__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('BSM', 'Connection')))
    ...
    _DDateTime_year = INT(name='year', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'DYear')), opt=True)
    _DDateTime_month = INT(name='month', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'DMonth')), opt=True)
    _DDateTime_day = INT(name='day', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'DDay')), opt=True)
    _DDateTime_hour = INT(name='hour', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'DHour')), opt=True)
    _DDateTime_minute = INT(name='minute', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'DMinute')), opt=True)
    _DDateTime_second = INT(name='second', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'DSecond')), opt=True)
    _DDateTime_offset = INT(name='offset', mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'DTimeOffset')), opt=True)
    ...
    _FullPositionVector_utcTime = SEQ(name='utcTime', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'DDateTime')), opt=True)
    _FullPositionVector_pos = SEQ(name='pos', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Position3D')))
    _FullPositionVector_heading = INT(name='heading', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Heading')), opt=True)
    _FullPositionVector_transmission = ENUM(name='transmission', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'TransmissionState')), opt=True)
    _FullPositionVector_speed = INT(name='speed', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Speed')), opt=True)
    _FullPositionVector_posAccuracy = SEQ(name='posAccuracy', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'PositionConfidenceSet')), opt=True)
    _FullPositionVector_timeConfidence = ENUM(name='timeConfidence', mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'TimeConfidence')), opt=True)
    _FullPositionVector_motionCfd = SEQ(name='motionCfd', mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'MotionConfidenceSet')), opt=True)
    ...
    _IntersectionState_intersectionId = SEQ(name='intersectionId', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'NodeReferenceID')))
    _IntersectionState_status = BIT_STR(name='status', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'IntersectionStatusObject')))
    _IntersectionState_moy = INT(name='moy', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'MinuteOfTheYear')), opt=True)
    _IntersectionState_timeStamp = INT(name='timeStamp', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'DSecond')), opt=True)
    _IntersectionState_timeConfidence = ENUM(name='timeConfidence', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'TimeConfidence')), opt=True)
    _IntersectionState_phases = SEQ_OF(name='phases', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'PhaseList')))
    ...
    _IntersectionStateList__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('BSM', 'IntersectionState')))
    ...
    _Lane_laneID = INT(name='laneID', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'LaneID')))
    _Lane_laneWidth = INT(name='laneWidth', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'LaneWidth')), opt=True)
    _Lane_laneAttributes = SEQ(name='laneAttributes', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'LaneAttributes')), opt=True)
    _Lane_maneuvers = BIT_STR(name='maneuvers', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'AllowedManeuvers')), opt=True)
    _Lane_connectsTo = SEQ_OF(name='connectsTo', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'ConnectsToList')), opt=True)
    _Lane_speedLimits = SEQ_OF(name='speedLimits', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'SpeedLimitList')), opt=True)
    _Lane_points = SEQ_OF(name='points', mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'PointList')), opt=True)
    Lane._cont = ASN1Dict([
        ('laneID', _Lane_laneID),
    ...
    _LaneAttributes_shareWith = BIT_STR(name='shareWith', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'LaneSharing')), opt=True)
    _LaneAttributes_laneType = CHOICE(name='laneType', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT), typeref=ASN1RefType(('BSM', 'LaneTypeAttributes')))
    ...
    _LaneList__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('BSM', 'Lane')))
    ...
    _LaneTypeAttributes_vehicle = BIT_STR(name='vehicle', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'LaneAttributes-Vehicle')))
    _LaneTypeAttributes_crosswalk = BIT_STR(name='crosswalk', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'LaneAttributes-Crosswalk')))
    _LaneTypeAttributes_bikeLane = BIT_STR(name='bikeLane', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'LaneAttributes-Bike')))
    _LaneTypeAttributes_sidewalk = BIT_STR(name='sidewalk', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'LaneAttributes-Sidewalk')))
    _LaneTypeAttributes_median = BIT_STR(name='median', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'LaneAttributes-Barrier')))
    _LaneTypeAttributes_striping = BIT_STR(name='striping', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'LaneAttributes-Striping')))
    _LaneTypeAttributes_trackedVehicle = BIT_STR(name='trackedVehicle', mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'LaneAttributes-TrackedVehicle')))
    _LaneTypeAttributes_parking = BIT_STR(name='parking', mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'LaneAttributes-Parking')))
    ...
    _Link_name = STR_IA5(name='name', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'DescriptiveName')), opt=True)
    _Link_upstreamNodeId = SEQ(name='upstreamNodeId', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'NodeReferenceID')))
    _Link_speedLimits = SEQ_OF(name='speedLimits', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'SpeedLimitList')), opt=True)
    _Link_linkWidth = INT(name='linkWidth', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'LaneWidth')))
    _Link_points = SEQ_OF(name='points', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'PointList')), opt=True)
    _Link_movements = SEQ_OF(name='movements', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'MovementList')), opt=True)
    _Link_lanes = SEQ_OF(name='lanes', mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'LaneList')))
    Link._cont = ASN1Dict([
        ('name', _Link_name),
    ...
    _LinkList__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('BSM', 'Link')))
    ...
    _MotionConfidenceSet_speedCfd = ENUM(name='speedCfd', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'SpeedConfidence')), opt=True)
    _MotionConfidenceSet_headingCfd = ENUM(name='headingCfd', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'HeadingConfidence')), opt=True)
    _MotionConfidenceSet_steerCfd = ENUM(name='steerCfd', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'SteeringWheelAngleConfidence')), opt=True)
    ...
    _Movement_remoteintersection = SEQ(name='remoteintersection', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'NodeReferenceID')))
    _Movement_phaseId = INT(name='phaseId', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'PhaseID')), opt=True)
    ...
    _MovementList__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('BSM', 'Movement')))
    ...
    _Node_name = STR_IA5(name='name', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'DescriptiveName')), opt=True)
    _Node_id = SEQ(name='id', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'NodeReferenceID')))
    _Node_refPos = SEQ(name='refPos', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Position3D')))
    _Node_inLinks = SEQ_OF(name='inLinks', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'LinkList')), opt=True)
    Node._cont = ASN1Dict([
        ('name', _Node_name),
        ('id', _Node_id),
        ('refPos', _Node_refPos),
    ...
    _NodeList__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('BSM', 'Node')))
    ...
    _NodeReferenceID_region = INT(name='region', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'RoadRegulatorID')), opt=True)
    _NodeReferenceID_id = INT(name='id', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'NodeID')))
    ...
    _ParticipantData_ptcType = ENUM(name='ptcType', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'ParticipantType')))
    ...
    _ParticipantData_source = ENUM(name='source', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'SourceType')))
    ...
    _ParticipantData_secMark = INT(name='secMark', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'DSecond')))
    _ParticipantData_pos = SEQ(name='pos', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'PositionOffsetLLV')))
    _ParticipantData_posConfidence = SEQ(name='posConfidence', mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'PositionConfidenceSet')))
    _ParticipantData_transmission = ENUM(name='transmission', mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'TransmissionState')), opt=True)
    _ParticipantData_speed = INT(name='speed', mode=MODE_TYPE, tag=(8, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Speed')))
    _ParticipantData_heading = INT(name='heading', mode=MODE_TYPE, tag=(9, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Heading')))
    _ParticipantData_angle = INT(name='angle', mode=MODE_TYPE, tag=(10, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'SteeringWheelAngle')), opt=True)
    _ParticipantData_motionCfd = SEQ(name='motionCfd', mode=MODE_TYPE, tag=(11, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'MotionConfidenceSet')), opt=True)
    _ParticipantData_accelSet = SEQ(name='accelSet', mode=MODE_TYPE, tag=(12, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'AccelerationSet4Way')), opt=True)
    _ParticipantData_size = SEQ(name='size', mode=MODE_TYPE, tag=(13, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'VehicleSize')))
    _ParticipantData_vehicleClass = SEQ(name='vehicleClass', mode=MODE_TYPE, tag=(14, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'VehicleClassification')), opt=True)
    ...
    _ParticipantList__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('BSM', 'ParticipantData')))
    ...
    _PathHistory_initialPosition = SEQ(name='initialPosition', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'FullPositionVector')), opt=True)
    _PathHistory_currGNSSstatus = BIT_STR(name='currGNSSstatus', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'GNSSstatus')), opt=True)
    _PathHistory_crumbData = SEQ_OF(name='crumbData', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'PathHistoryPointList')))
    ...
    _PathHistoryPoint_llvOffset = SEQ(name='llvOffset', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'PositionOffsetLLV')))
    _PathHistoryPoint_timeOffset = INT(name='timeOffset', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'TimeOffset')))
    _PathHistoryPoint_speed = INT(name='speed', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Speed')), opt=True)
    _PathHistoryPoint_posAccuracy = SEQ(name='posAccuracy', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'PositionConfidenceSet')), opt=True)
    _PathHistoryPoint_heading = INT(name='heading', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'CoarseHeading')), opt=True)
    ...
    _PathHistoryPointList__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('BSM', 'PathHistoryPoint')))
    ...
    _PathPointList__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('BSM', 'PositionOffsetLLV')))
    ...
    _PathPrediction_radiusOfCurve = INT(name='radiusOfCurve', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'RadiusOfCurvature')))
    _PathPrediction_confidence = INT(name='confidence', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Confidence')))
    ...
    _Phase_id = INT(name='id', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'PhaseID')))
    _Phase_phaseStates = SEQ_OF(name='phaseStates', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'PhaseStateList')))
    ...
    _PhaseList__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('BSM', 'Phase')))
    ...
    _PhaseState_light = ENUM(name='light', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'LightState')))
    _PhaseState_timing = CHOICE(name='timing', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT), typeref=ASN1RefType(('BSM', 'TimeChangeDetails')), opt=True)
    ...
    _PhaseStateList__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('BSM', 'PhaseState')))
    ...
    _PointList__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('BSM', 'RoadPoint')))
    ...
    _Position_LL_24B_lon = INT(name='lon', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'OffsetLL-B12')))
    _Position_LL_24B_lat = INT(name='lat', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'OffsetLL-B12')))
    ...
    _Position_LL_28B_lon = INT(name='lon', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'OffsetLL-B14')))
    _Position_LL_28B_lat = INT(name='lat', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'OffsetLL-B14')))
    ...
    _Position_LL_32B_lon = INT(name='lon', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'OffsetLL-B16')))
    _Position_LL_32B_lat = INT(name='lat', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'OffsetLL-B16')))
    ...
    _Position_LL_36B_lon = INT(name='lon', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'OffsetLL-B18')))
    _Position_LL_36B_lat = INT(name='lat', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'OffsetLL-B18')))
    ...
    _Position_LL_44B_lon = INT(name='lon', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'OffsetLL-B22')))
    _Position_LL_44B_lat = INT(name='lat', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'OffsetLL-B22')))
    ...
    _Position_LL_48B_lon = INT(name='lon', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'OffsetLL-B24')))
    _Position_LL_48B_lat = INT(name='lat', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'OffsetLL-B24')))
    ...
    _Position_LLmD_64b_lon = INT(name='lon', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Longitude')))
    _Position_LLmD_64b_lat = INT(name='lat', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Latitude')))
    ...
    _Position3D_lat = INT(name='lat', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Latitude')))
    _Position3D_long = INT(name='long', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Longitude')))
    _Position3D_elevation = INT(name='elevation', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Elevation')), opt=True)
    ...
    _PositionalAccuracy_semiMajor = INT(name='semiMajor', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'SemiMajorAxisAccuracy')))
    _PositionalAccuracy_semiMinor = INT(name='semiMinor', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'SemiMinorAxisAccuracy')))
    _PositionalAccuracy_orientation = INT(name='orientation', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'SemiMajorAxisOrientation')))
    ...
    _PositionConfidenceSet_pos = ENUM(name='pos', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'PositionConfidence')))
    _PositionConfidenceSet_elevation = ENUM(name='elevation', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'ElevationConfidence')), opt=True)
    ...
    _PositionOffsetLL_position_LL1 = SEQ(name='position-LL1', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Position-LL-24B')))
    _PositionOffsetLL_position_LL2 = SEQ(name='position-LL2', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Position-LL-28B')))
    _PositionOffsetLL_position_LL3 = SEQ(name='position-LL3', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Position-LL-32B')))
    _PositionOffsetLL_position_LL4 = SEQ(name='position-LL4', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Position-LL-36B')))
    _PositionOffsetLL_position_LL5 = SEQ(name='position-LL5', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Position-LL-44B')))
    _PositionOffsetLL_position_LL6 = SEQ(name='position-LL6', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Position-LL-48B')))
    _PositionOffsetLL_position_LatLon = SEQ(name='position-LatLon', mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Position-LLmD-64b')))
    ...
    _PositionOffsetLLV_offsetLL = CHOICE(name='offsetLL', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT), typeref=ASN1RefType(('BSM', 'PositionOffsetLL')))
    _PositionOffsetLLV_offsetV = CHOICE(name='offsetV', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT), typeref=ASN1RefType(('BSM', 'VerticalOffset')), opt=True)
    ...
    _ReferenceLink_upstreamNodeId = SEQ(name='upstreamNodeId', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'NodeReferenceID')))
    _ReferenceLink_downstreamNodeId = SEQ(name='downstreamNodeId', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'NodeReferenceID')))
    _ReferenceLink_referenceLanes = BIT_STR(name='referenceLanes', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'ReferenceLanes')), opt=True)
    ...
    _ReferenceLinkList__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('BSM', 'ReferenceLink')))
    ...
    _ReferencePath_activePath = SEQ_OF(name='activePath', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'PathPointList')))
    _ReferencePath_pathRadius = INT(name='pathRadius', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Radius')))
    ...
    _ReferencePathList__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('BSM', 'ReferencePath')))
    ...
    _RegulatorySpeedLimit_type = ENUM(name='type', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'SpeedLimitType')))
    _RegulatorySpeedLimit_speed = INT(name='speed', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Speed')))
    ...
    _RSITimeDetails_startTime = INT(name='startTime', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'MinuteOfTheYear')), opt=True)
    _RSITimeDetails_endTime = INT(name='endTime', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'MinuteOfTheYear')), opt=True)
    _RSITimeDetails_endTimeConfidence = ENUM(name='endTimeConfidence', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'TimeConfidence')), opt=True)
    ...
    _RTEData_eventType = INT(name='eventType', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'EventType')))
    _RTEData_eventSource = ENUM(name='eventSource', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'EventSource')))
    _RTEData_eventPos = SEQ(name='eventPos', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'PositionOffsetLLV')), opt=True)
    _RTEData_eventRadius = INT(name='eventRadius', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Radius')), opt=True)
    _RTEData_description = CHOICE(name='description', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_EXPLICIT), typeref=ASN1RefType(('BSM', 'Description')), opt=True)
    _RTEData_timeDetails = SEQ(name='timeDetails', mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'RSITimeDetails')), opt=True)
    _RTEData_priority = OCT_STR(name='priority', mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'RSIPriority')), opt=True)
    _RTEData_referencePaths = SEQ_OF(name='referencePaths', mode=MODE_TYPE, tag=(8, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'ReferencePathList')), opt=True)
    _RTEData_referenceLinks = SEQ_OF(name='referenceLinks', mode=MODE_TYPE, tag=(9, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'ReferenceLinkList')), opt=True)
    _RTEData_eventConfidence = INT(name='eventConfidence', mode=MODE_TYPE, tag=(10, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Confidence')), opt=True)
    ...
    _RTEList__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('BSM', 'RTEData')))
    ...
    _RTSData_signType = INT(name='signType', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'SignType')))
    _RTSData_signPos = SEQ(name='signPos', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'PositionOffsetLLV')), opt=True)
    _RTSData_description = CHOICE(name='description', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_EXPLICIT), typeref=ASN1RefType(('BSM', 'Description')), opt=True)
    _RTSData_timeDetails = SEQ(name='timeDetails', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'RSITimeDetails')), opt=True)
    _RTSData_priority = OCT_STR(name='priority', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'RSIPriority')), opt=True)
    _RTSData_referencePaths = SEQ_OF(name='referencePaths', mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'ReferencePathList')), opt=True)
    _RTSData_referenceLinks = SEQ_OF(name='referenceLinks', mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'ReferenceLinkList')), opt=True)
    ...
    _RTSList__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('BSM', 'RTSData')))
    ...
    _RoadPoint_posOffset = SEQ(name='posOffset', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'PositionOffsetLLV')))
    ...
    _SignalState_status = BIT_STR(name='status', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'IntersectionStatusObject')))
    _SignalState_moy = INT(name='moy', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'MinuteOfTheYear')), opt=True)
    _SignalState_timeStamp = INT(name='timeStamp', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'DSecond')), opt=True)
    _SignalState_phases = SEQ_OF(name='phases', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'PhaseList')))
    ...
    _SpeedLimitList__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('BSM', 'RegulatorySpeedLimit')))
    ...
    _TimeChangeDetails_counting = SEQ(name='counting', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'TimeCountingDown')))
    _TimeChangeDetails_utcTiming = SEQ(name='utcTiming', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'UTCTiming')))
    ...
    _TimeCountingDown_startTime = INT(name='startTime', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'TimeMark')))
    _TimeCountingDown_minEndTime = INT(name='minEndTime', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'TimeMark')), opt=True)
    _TimeCountingDown_maxEndTime = INT(name='maxEndTime', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'TimeMark')), opt=True)
    _TimeCountingDown_likelyEndTime = INT(name='likelyEndTime', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'TimeMark')))
    _TimeCountingDown_timeConfidence = INT(name='timeConfidence', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Confidence')), opt=True)
    _TimeCountingDown_nextStartTime = INT(name='nextStartTime', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'TimeMark')), opt=True)
    _TimeCountingDown_nextDuration = INT(name='nextDuration', mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'TimeMark')), opt=True)
    ...
    _UTCTiming_startUTCTime = INT(name='startUTCTime', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'TimeMark')))
    _UTCTiming_minEndUTCTime = INT(name='minEndUTCTime', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'TimeMark')), opt=True)
    _UTCTiming_maxEndUTCTime = INT(name='maxEndUTCTime', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'TimeMark')), opt=True)
    _UTCTiming_likelyEndUTCTime = INT(name='likelyEndUTCTime', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'TimeMark')))
    _UTCTiming_timeConfidence = INT(name='timeConfidence', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Confidence')), opt=True)
    _UTCTiming_nextStartUTCTime = INT(name='nextStartUTCTime', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'TimeMark')), opt=True)
    _UTCTiming_nextEndUTCTime = INT(name='nextEndUTCTime', mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'TimeMark')), opt=True)
    ...
    _VehicleClassification_classification = INT(name='classification', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    _VehicleClassification_fuelType = INT(name='fuelType', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'FuelType')), opt=True)
    ...
    _VehicleEmergencyExtensions_responseType = ENUM(name='responseType', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'ResponseType')), opt=True)
    _VehicleEmergencyExtensions_sirenUse = ENUM(name='sirenUse', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'SirenInUse')), opt=True)
    _VehicleEmergencyExtensions_lightsUse = ENUM(name='lightsUse', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'LightbarInUse')), opt=True)
    ...
    _VehicleSafetyExtensions_events = BIT_STR(name='events', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'VehicleEventFlags')), opt=True)
    _VehicleSafetyExtensions_pathHistory = SEQ(name='pathHistory', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'PathHistory')), opt=True)
    _VehicleSafetyExtensions_pathPrediction = SEQ(name='pathPrediction', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'PathPrediction')), opt=True)
    _VehicleSafetyExtensions_lights = BIT_STR(name='lights', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'ExteriorLights')), opt=True)
    ...
    _VehicleSize_width = INT(name='width', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'VehicleWidth')))
    _VehicleSize_length = INT(name='length', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'VehicleLength')))
    _VehicleSize_height = INT(name='height', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'VehicleHeight')), opt=True)
    ...
    _VerticalOffset_offset1 = INT(name='offset1', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'VertOffset-B07')))
    _VerticalOffset_offset2 = INT(name='offset2', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'VertOffset-B08')))
    _VerticalOffset_offset3 = INT(name='offset3', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'VertOffset-B09')))
    _VerticalOffset_offset4 = INT(name='offset4', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'VertOffset-B10')))
    _VerticalOffset_offset5 = INT(name='offset5', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'VertOffset-B11')))
    _VerticalOffset_offset6 = INT(name='offset6', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'VertOffset-B12')))
    _VerticalOffset_elevation = INT(name='elevation', mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('BSM', 'Elevation')))
    ...
    #-----< unknownVehicleClass >-----#
    unknownVehicleClass = INT(name='unknownVehicleClass', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    unknownVehicleClass._val = 0
    
    #-----< specialVehicleClass >-----#
    specialVehicleClass = INT(name='specialVehicleClass', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    specialVehicleClass._val = 1
    
    #-----< passenger-Vehicle-TypeUnknown >-----#
    passenger_Vehicle_TypeUnknown = INT(name='passenger-Vehicle-TypeUnknown', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    passenger_Vehicle_TypeUnknown._val = 10
    
    #-----< passenger-Vehicle-TypeOther >-----#
    passenger_Vehicle_TypeOther = INT(name='passenger-Vehicle-TypeOther', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    passenger_Vehicle_TypeOther._val = 11
    
    #-----< lightTruck-Vehicle-TypeUnknown >-----#
    lightTruck_Vehicle_TypeUnknown = INT(name='lightTruck-Vehicle-TypeUnknown', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    lightTruck_Vehicle_TypeUnknown._val = 20
    
    #-----< lightTruck-Vehicle-TypeOther >-----#
    lightTruck_Vehicle_TypeOther = INT(name='lightTruck-Vehicle-TypeOther', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    lightTruck_Vehicle_TypeOther._val = 21
    
    #-----< truck-Vehicle-TypeUnknown >-----#
    truck_Vehicle_TypeUnknown = INT(name='truck-Vehicle-TypeUnknown', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    truck_Vehicle_TypeUnknown._val = 25
    
    #-----< truck-Vehicle-TypeOther >-----#
    truck_Vehicle_TypeOther = INT(name='truck-Vehicle-TypeOther', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    truck_Vehicle_TypeOther._val = 26
    
    #-----< truck-axleCnt2 >-----#
    truck_axleCnt2 = INT(name='truck-axleCnt2', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    truck_axleCnt2._val = 27
    
    #-----< truck-axleCnt3 >-----#
    truck_axleCnt3 = INT(name='truck-axleCnt3', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    truck_axleCnt3._val = 28
    
    #-----< truck-axleCnt4 >-----#
    truck_axleCnt4 = INT(name='truck-axleCnt4', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    truck_axleCnt4._val = 29
    
    #-----< truck-axleCnt4Trailer >-----#
    truck_axleCnt4Trailer = INT(name='truck-axleCnt4Trailer', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    truck_axleCnt4Trailer._val = 30
    
    #-----< truck-axleCnt5Trailer >-----#
    truck_axleCnt5Trailer = INT(name='truck-axleCnt5Trailer', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    truck_axleCnt5Trailer._val = 31
    
    #-----< truck-axleCnt6Trailer >-----#
    truck_axleCnt6Trailer = INT(name='truck-axleCnt6Trailer', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    truck_axleCnt6Trailer._val = 32
    
    #-----< truck-axleCnt5MultiTrailer >-----#
    truck_axleCnt5MultiTrailer = INT(name='truck-axleCnt5MultiTrailer', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    truck_axleCnt5MultiTrailer._val = 33
    
    #-----< truck-axleCnt6MultiTrailer >-----#
    truck_axleCnt6MultiTrailer = INT(name='truck-axleCnt6MultiTrailer', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    truck_axleCnt6MultiTrailer._val = 34
    
    #-----< truck-axleCnt7MultiTrailer >-----#
    truck_axleCnt7MultiTrailer = INT(name='truck-axleCnt7MultiTrailer', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    truck_axleCnt7MultiTrailer._val = 35
    
    #-----< motorcycle-TypeUnknown >-----#
    motorcycle_TypeUnknown = INT(name='motorcycle-TypeUnknown', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    motorcycle_TypeUnknown._val = 40
    
    #-----< motorcycle-TypeOther >-----#
    motorcycle_TypeOther = INT(name='motorcycle-TypeOther', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    motorcycle_TypeOther._val = 41
    
    #-----< motorcycle-Cruiser-Standard >-----#
    motorcycle_Cruiser_Standard = INT(name='motorcycle-Cruiser-Standard', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    motorcycle_Cruiser_Standard._val = 42
    
    #-----< motorcycle-SportUnclad >-----#
    motorcycle_SportUnclad = INT(name='motorcycle-SportUnclad', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    motorcycle_SportUnclad._val = 43
    
    #-----< motorcycle-SportTouring >-----#
    motorcycle_SportTouring = INT(name='motorcycle-SportTouring', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    motorcycle_SportTouring._val = 44
    
    #-----< motorcycle-SuperSport >-----#
    motorcycle_SuperSport = INT(name='motorcycle-SuperSport', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    motorcycle_SuperSport._val = 45
    
    #-----< motorcycle-Touring >-----#
    motorcycle_Touring = INT(name='motorcycle-Touring', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    motorcycle_Touring._val = 46
    
    #-----< motorcycle-Trike >-----#
    motorcycle_Trike = INT(name='motorcycle-Trike', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    motorcycle_Trike._val = 47
    
    #-----< motorcycle-wPassengers >-----#
    motorcycle_wPassengers = INT(name='motorcycle-wPassengers', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    motorcycle_wPassengers._val = 48
    
    #-----< transit-TypeUnknown >-----#
    transit_TypeUnknown = INT(name='transit-TypeUnknown', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    transit_TypeUnknown._val = 50
    
    #-----< transit-TypeOther >-----#
    transit_TypeOther = INT(name='transit-TypeOther', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    transit_TypeOther._val = 51
    
    #-----< transit-BRT >-----#
    transit_BRT = INT(name='transit-BRT', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    transit_BRT._val = 52
    
    #-----< transit-ExpressBus >-----#
    transit_ExpressBus = INT(name='transit-ExpressBus', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    transit_ExpressBus._val = 53
    
    #-----< transit-LocalBus >-----#
    transit_LocalBus = INT(name='transit-LocalBus', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    transit_LocalBus._val = 54
    
    #-----< transit-SchoolBus >-----#
    transit_SchoolBus = INT(name='transit-SchoolBus', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    transit_SchoolBus._val = 55
    
    #-----< transit-FixedGuideway >-----#
    transit_FixedGuideway = INT(name='transit-FixedGuideway', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    transit_FixedGuideway._val = 56
    
    #-----< transit-Paratransit >-----#
    transit_Paratransit = INT(name='transit-Paratransit', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    transit_Paratransit._val = 57
    
    #-----< transit-Paratransit-Ambulance >-----#
    transit_Paratransit_Ambulance = INT(name='transit-Paratransit-Ambulance', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    transit_Paratransit_Ambulance._val = 58
    
    #-----< emergency-TypeUnknown >-----#
    emergency_TypeUnknown = INT(name='emergency-TypeUnknown', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    emergency_TypeUnknown._val = 60
    
    #-----< emergency-TypeOther >-----#
    emergency_TypeOther = INT(name='emergency-TypeOther', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    emergency_TypeOther._val = 61
    
    #-----< emergency-Fire-Light-Vehicle >-----#
    emergency_Fire_Light_Vehicle = INT(name='emergency-Fire-Light-Vehicle', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    emergency_Fire_Light_Vehicle._val = 62
    
    #-----< emergency-Fire-Heavy-Vehicle >-----#
    emergency_Fire_Heavy_Vehicle = INT(name='emergency-Fire-Heavy-Vehicle', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    emergency_Fire_Heavy_Vehicle._val = 63
    
    #-----< emergency-Fire-Paramedic-Vehicle >-----#
    emergency_Fire_Paramedic_Vehicle = INT(name='emergency-Fire-Paramedic-Vehicle', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    emergency_Fire_Paramedic_Vehicle._val = 64
    
    #-----< emergency-Fire-Ambulance-Vehicle >-----#
    emergency_Fire_Ambulance_Vehicle = INT(name='emergency-Fire-Ambulance-Vehicle', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    emergency_Fire_Ambulance_Vehicle._val = 65
    
    #-----< emergency-Police-Light-Vehicle >-----#
    emergency_Police_Light_Vehicle = INT(name='emergency-Police-Light-Vehicle', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    emergency_Police_Light_Vehicle._val = 66
    
    #-----< emergency-Police-Heavy-Vehicle >-----#
    emergency_Police_Heavy_Vehicle = INT(name='emergency-Police-Heavy-Vehicle', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    emergency_Police_Heavy_Vehicle._val = 67
    
    #-----< emergency-Other-Responder >-----#
    emergency_Other_Responder = INT(name='emergency-Other-Responder', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    emergency_Other_Responder._val = 68
    
    #-----< emergency-Other-Ambulance >-----#
    emergency_Other_Ambulance = INT(name='emergency-Other-Ambulance', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    emergency_Other_Ambulance._val = 69
    
    #-----< otherTraveler-TypeUnknown >-----#
    otherTraveler_TypeUnknown = INT(name='otherTraveler-TypeUnknown', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    otherTraveler_TypeUnknown._val = 80
    
    #-----< otherTraveler-TypeOther >-----#
    otherTraveler_TypeOther = INT(name='otherTraveler-TypeOther', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    otherTraveler_TypeOther._val = 81
    
    #-----< otherTraveler-Pedestrian >-----#
    otherTraveler_Pedestrian = INT(name='otherTraveler-Pedestrian', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    otherTraveler_Pedestrian._val = 82
    
    #-----< otherTraveler-Visually-Disabled >-----#
    otherTraveler_Visually_Disabled = INT(name='otherTraveler-Visually-Disabled', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    otherTraveler_Visually_Disabled._val = 83
    
    #-----< otherTraveler-Physically-Disabled >-----#
    otherTraveler_Physically_Disabled = INT(name='otherTraveler-Physically-Disabled', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    otherTraveler_Physically_Disabled._val = 84
    
    #-----< otherTraveler-Bicycle >-----#
    otherTraveler_Bicycle = INT(name='otherTraveler-Bicycle', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    otherTraveler_Bicycle._val = 85
    
    #-----< otherTraveler-Vulnerable-Roadworker >-----#
    otherTraveler_Vulnerable_Roadworker = INT(name='otherTraveler-Vulnerable-Roadworker', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    otherTraveler_Vulnerable_Roadworker._val = 86
    
    #-----< infrastructure-TypeUnknown >-----#
    infrastructure_TypeUnknown = INT(name='infrastructure-TypeUnknown', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    infrastructure_TypeUnknown._val = 90
    
    #-----< infrastructure-Fixed >-----#
    infrastructure_Fixed = INT(name='infrastructure-Fixed', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    infrastructure_Fixed._val = 91
    
    #-----< infrastructure-Movable >-----#
    infrastructure_Movable = INT(name='infrastructure-Movable', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    infrastructure_Movable._val = 92
    
    #-----< equipped-CargoTrailer >-----#
    equipped_CargoTrailer = INT(name='equipped-CargoTrailer', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'BasicVehicleClass')))
    ...
    #-----< unknownFuel >-----#
    unknownFuel = INT(name='unknownFuel', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'FuelType')))
    unknownFuel._val = 0
    
    #-----< gasoline >-----#
    gasoline = INT(name='gasoline', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'FuelType')))
    gasoline._val = 1
    
    #-----< ethanol >-----#
    ethanol = INT(name='ethanol', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'FuelType')))
    ethanol._val = 2
    
    #-----< diesel >-----#
    diesel = INT(name='diesel', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'FuelType')))
    diesel._val = 3
    
    #-----< electric >-----#
    electric = INT(name='electric', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'FuelType')))
    electric._val = 4
    
    #-----< hybrid >-----#
    hybrid = INT(name='hybrid', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'FuelType')))
    hybrid._val = 5
    
    #-----< hydrogen >-----#
    hydrogen = INT(name='hydrogen', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'FuelType')))
    hydrogen._val = 6
    
    #-----< natGasLiquid >-----#
    natGasLiquid = INT(name='natGasLiquid', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'FuelType')))
    natGasLiquid._val = 7
    
    #-----< natGasComp >-----#
    natGasComp = INT(name='natGasComp', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'FuelType')))
    natGasComp._val = 8
    
    #-----< propane >-----#
    propane = INT(name='propane', mode=MODE_VALUE, typeref=ASN1RefType(('BSM', 'FuelType')))
    propane._val = 9
    ...
    IntersectionStatusObject._cont = ASN1Dict([('manualControlIsEnabled', 0), ('stopTimelsActivated', 1), ('failureFlash', 2), ('preemptlsActive', 3), ('signalPrioritylsActive', 4), ('fixedTimeOperation', 5), ('trafficDependentOperation', 6), ('standbyOperation', 7), ('failureMode', 8), ('off', 9), ('recentMAPmessageUpdate', 10), ('recentChangelnMAPassignedLanesIDsUsed', 11), ('noValidMAPisAvailableAtThisTime', 12), ('noValidSPATisAvailableAtThisTime', 13)])
    ...
    LaneAttributes_Parking._cont = ASN1Dict([('parkingRevocableLane', 0), ('parallelParkinglnUse', 1), ('headlnParkinglnUse', 2), ('doNotParkZone', 3), ('parkingForBusUse', 4), ('parkingForTaxiUse', 5), ('noPublicParkingUse', 6)])
    ...
    LightbarInUse._cont = ASN1Dict([('unavailable', 0), ('notlnUse', 1), ('inUse', 2), ('yellowCautionLights', 3), ('schooIdBusLights', 4), ('arrowSignsActive', 5), ('slowMovingVehicle', 6), ('freqStops', 7)])
    ...
    SirenInUse._cont = ASN1Dict([('unavailable', 0), ('notlnUse', 1), ('inUse', 2), ('reserved', 3)])
    ...
    SpeedLimitType._cont = ASN1Dict([('unknown', 0), ('maxSpeedlnSchoolZone', 1), ('maxSpeedlnSchoolZoneWhenChildrenArePresent', 2), ('maxSpeedlnConstructionZone', 3), ('vehicleMinSpeed', 4), ('vehicleMaxSpeed', 5), ('vehicleNightMaxSpeed', 6), ('truckMinSpeed', 7), ('truckMaxSpeed', 8), ('truckNightMaxSpeed', 9), ('vehiclesWithTrailersMinSpeed', 10), ('vehiclesWithTrailersMaxSpeed', 11), ('vehiclesWithTrailersNightMaxSpeed', 12)])
    SpeedLimitType._ext = []
